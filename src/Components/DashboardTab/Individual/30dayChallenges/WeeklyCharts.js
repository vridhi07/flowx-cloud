    ...
    if (allweekData.length) {
      ...
      if (avgOfAllWeekFlow.length && avgOfAllWeekCoherance.length) {
        let allWeekData = weeklyData(
          ...
          allWeekCoherancePercentageChange
            ? allWeekCoherancePercentageChange
            : 0
        );
        ...
        setAllWeekPercentageData({
          ...
          flowPercentChange: allWeekFlowPercentageChange
            ? allWeekFlowPercentageChange
            : 0,
          coherencePercentChange: allWeekCoherancePercentageChange
            ? allWeekCoherancePercentageChange
            : 0,
